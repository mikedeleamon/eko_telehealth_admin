...
const NAV = [
  ...
  { href: "/revenue", label: "Revenue Analysis", icon: "📈" },
  ...
  { href: "/moderation", label: "Message Moderation", icon: "🛡" },
  { href: "/users", label: "Users", icon: "👤" },
  { href: "/appointments", label: "Appointments", icon: "📅" },
  { href: "/payouts", label: "Provider Payouts", icon: "💸" },
  { href: "/prescriptions", label: "Pharmacy Referrals", icon: "💊" },
  { href: "/promos", label: "Promo Codes", icon: "🏷" },
  { href: "/currencies", label: "Display Currencies", icon: "💱" },
